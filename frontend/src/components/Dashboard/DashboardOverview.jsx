...
//   const [totalDataPoints, setTotalDataPoints] = useState(14204); // Initial mock value

//   useEffect(() => {
//     // Connect to your backend socket server
//     const socket = io('http://localhost:5000');

//     // Mapped strictly to your ESP32 MQTT JSON payload
//     socket.on('telemetry_update', (data) => {
//       setLiveNodes(prev => ({
//         ...prev,
//         [data.clientId]: {
//           name: data.clientId, // e.g., "ESP32_Sensor_Node"
//           apiKey: data.clientId, // Reusing clientId for the API Key column
//           val: `${data.temperature || '--'}°C / ${data.humidity || '--'}%`,
...
//                   <th className="px-6 py-4">API Key / ID</th>
